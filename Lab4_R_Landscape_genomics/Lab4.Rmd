...
To run the code below and see its output, either click the green triangular "run" button, or click inside the code chunk and hit ctrl+enter (PC) or command+enter (Mac)
